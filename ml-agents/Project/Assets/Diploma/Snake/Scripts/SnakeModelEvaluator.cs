...
public class SnakeModelEvaluator : MonoBehaviour
{
    [Serializable]
    ...
    [SerializeField] private string behaviorName = "SnakeVector";
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("SnakeModelEvaluator: missing agent or gameManager.", this);
            enabled = false;
            return;
        }
        ...
        {
            Debug.LogError("SnakeModelEvaluator: agent has no BehaviorParameters.", this);
            enabled = false;
            return;
        }
